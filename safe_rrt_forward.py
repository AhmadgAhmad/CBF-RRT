...
class RRT():
    ...
    def __init__(self, start, goal, obstacleList,
                 randArea, expandDis=0.40, goalSampleRate=5, maxIter=30):
        """
        Setting Parameter
...
def main(gx=5, gy=5):
    ...
    obstacleList = [[-0.0,1.0,0.50],[1.0,0.5,0.50],[1.7,-0.5,0.5],[3,3,0.5],[2,4,0.5]]  # [x,y,size]
    # Set Initial parameters

    rrt = RRT(start=[-0.5, -0.5,1], goal=[gx, gy],
